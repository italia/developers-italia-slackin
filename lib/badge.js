...
const title = 'No slack?'
const alt_title = 'Get your invite'
const color = '#06c'
...
export default function badge ({ total, active }){
  ...
  let value = alt_title // HACK: Static title
  ...
  return svg(`svg xmlns="http://www.w3.org/2000/svg" width=${tw} height=20`,
    ...
    svg('g text-anchor=middle font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size=11',
